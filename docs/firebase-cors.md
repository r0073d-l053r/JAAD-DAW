...
2. Select your project from the project dropdown at the top.
...
# Apply the CORS policy to your bucket (replace [PROJECT_ID] with your actual ID)
...
### 🛑 Still failing?
If the command says "Bucket not found", check your Firebase Console under **Storage** to see the exact bucket name (it's at the top of the file list). It should look like `gs://your-project.appspot.com`.
